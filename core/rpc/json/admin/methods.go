...
const (
	...
	MethodBlacklistPeer         jsonrpc.Method = "admin.blacklist_peer"
	MethodRemoveBlacklistedPeer jsonrpc.Method = "admin.remove_blacklisted_peer"
	MethodListBlacklistedPeers  jsonrpc.Method = "admin.list_blacklisted_peers"
